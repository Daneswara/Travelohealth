...
/** https://travelohealth.000webhostapp.com/m/api/patient/auth/login
...
//                        Toast.makeText(LoginActivity.this, response.body().getData().getMessage().getNotify().get(0).getM(), Toast.LENGTH_LONG).show();
    ...
    private void attemptLogin() {
        ...
        if (TextUtils.isEmpty(email)) {
            mEmailView.setError("User ID harus diisi!");
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                mPasswordView.setError("User ID atau Password anda kurang tepat");
